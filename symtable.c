...
/*
 lab9:
  this is cminus code
  we use the functions from this in the y file
  Insert inserts something into the symbol table granted it's not in it already
  Search looks for something in the symbol table
  Delete deletes all symbol table entries with the corresponding level
*/
